...
export const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      {
        label: 'Nouveau C/F',
        link: '/client/NouveauComponent',
      },
      {
        label: 'List C/F',
        link: '/client/List-client'
      },
    ]
  },
  {
    ...
    subItems: [
      {
        label: 'Nouveau Devis',
        link: '/devis/Nouveau-Devis',
      },
      {
        label: 'List Devis',
        link: '/devis/Liste-Devis'
      },
    ]
  },
  {
    ...
    subItems: [
      {
        label: 'Nouveau Facture',
        link: '/facture-client/Nouveau',
      },
      {
        label: 'List Facture',
        link: '/facture-client/List'
      },
    ]
  },
  {
    ...
    subItems: [
      {
        label: 'Nouveau Facture',
        link: '/facture-fournisseur/Nouveau',
      },
      {
        label: 'List Facture',
        link: '/facture-fournisseur/List'
      },
    ]
  },
  {
  ...
  },
  {
    ...
    subItems: [
      {
        label: 'nouveau',
        link: '/bon-Livraison/nouveau',
      },
      {
        label: 'list',
        link: '/bon-Livraison/List'
      },
    ]
  },
  {
