...
import { NclientComponent } from './nclient/nclient.component';
...
@NgModule({
  declarations: [AdvancedFormElementsComponent, FormValidationComponent, InputMaskComponent, NgSelectComponent, NgxChipsComponent, NgxColorPickerComponent, NgxDropzoneWrapperComponent, NclientComponent],
  imports: [
    CommonModule,
